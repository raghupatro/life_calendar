...
Width = 24
Height = 36
DOC_WIDTH = PPI * Width   # 594mm / 23 3/8 inches
DOC_HEIGHT = PPI * Height  # 841mm / 33 1/8 inches

# DOC_NAME = "life_calendar.pdf"
DOC_NAME = "life_calendar.png"
...
BIGFONT_SIZE = (PPI/72)*40
SMALLFONT_SIZE = (PPI/72)*16
TINYFONT_SIZE = (PPI/72)*14

MAX_TITLE_SIZE = 30
DEFAULT_TITLE = "Life Calendar"

Y_MARGIN = DOC_HEIGHT/16
BOX_MARGIN = 8
...
def gen_calendar(birthdate, title, age, filename, darken_until_date, sidebar_text=None,
    ...
    surface = cairo.ImageSurface(cairo.FORMAT_ARGB32, DOC_WIDTH, DOC_HEIGHT)
